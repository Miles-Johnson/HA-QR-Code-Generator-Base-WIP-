...
const navigation = {
  ...
  social: [
    {
      name: "Facebook",
      href: "https://www.facebook.com/profile.php?id=61555228354974&mibextid=ZbWKwL",
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/hartsyai",
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "Twitter",
      href: "https://twitter.com/@hartsyai",
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      name: "Reddit",
      href: "https://www.reddit.com/r/HartsyAI/",
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      name: "YouTube",
      href: "https://www.youtube.com/@HartsyAI",
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "Twitch",
      href: "https://www.twitch.tv/hartsyai",
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
    ...
    <footer className="bg-white">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 pt-20 sm:pt-24 lg:px-8">
        ...
        <p className="mt-2 text-center text-xs leading-5 text-gray-500">
          &copy; 2024 Hartsy, Inc. All rights reserved.
        </p>
      </div>
    </footer>
  );
